...
describe('Contact Class tests', () => {
    ...
    it('should set name correctly through constructor', () => {
        contact = new ContactClass("Gauri");
        expect(contact.name).toEqual("Gauri");
    });
    ...
    it('should get and set email correctly', () => {
        contact.email = "abc@sample.com";
        expect(contact.email).toEqual("abc@sample.com");
    });

    it('should get and set number correctly', () => {
        contact.number = "98909879";
        expect(contact.number).toEqual("98909879");
    });
